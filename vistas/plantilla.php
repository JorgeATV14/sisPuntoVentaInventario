...
<head>
  ...
  <title>Stihl Mi Ranchito</title>

  <!-- Tell the browser to be responsive to screen width -->
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">

  <link rel="icon" href="vistas/img/plantilla/MI RANCHITO.png">

  <!--=================
  ESTILOS DEL SISTEMA
  ==========-->

  <link rel="stylesheet" href="vistas/dist/css/SystemStyles.css">
...
<body class="hold-transition skin-blue sidebar-collapse sidebar-mini login-page">
  ...
  if (isset($_SESSION["iniciarSesion"]) && $_SESSION["iniciarSesion"] == "ok") {
    ...
    // Verifica el primer segmento para determinar la página solicitada
    $pagina = $segmentos[0];
    ...
    switch ($pagina) {
      ...
      case 'crear-venta':
        ...
        break;
      case 'editar-venta':
        include 'modulos/editar-venta.php';
        break;
      case 'reportes':
