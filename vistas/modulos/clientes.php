          ...
          foreach ($clientes as $key => $value) {
            ...
            echo '<tr>
                    ...
                    <td>
                      ...
                      //     echo '<button class="btn btn-danger btnEliminarCliente" idClienteEliminado="'.$value["id"].'"><i class="fa fa-times"></i></button>';
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" min="0" class="form-control input-lg" name="nuevoDocumentoId" placeholder="Ingresar INE">
